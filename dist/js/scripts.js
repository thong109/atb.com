(() => {
  ...
  let pageOffsetX = window.scrollX;
  ...
  function frozeWindow(isFroze, exception) {
    ...
    } else if (!isFroze && $("html").hasClass(classFrozenWindows)) {
      freezeWindows();
    } else if (!isFroze && $("html").hasClass(classFrozenOS)) {
      freezeOS();
    }
  }
